// FULL NAME: Brett Lay
//CLASS: ITCS 2530 C++ PROGRAMING 1
//GIT HUB URL: https://github.com/BrettLay/Final-Exam
// SUMMARY: This program generates a workout plan based on user input from a file.
// POSTED HOBBY: Working out and running
